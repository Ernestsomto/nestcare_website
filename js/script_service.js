...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle support form
    if (supportForm) {
        // IMPORTANT: Replace with your actual support email address
    ...
    function validateForm(form) {
        ...
        const service = form.querySelector('#service, #serviceType');
        ...
        const frequency = form.querySelector('#frequency');
        if (frequency && frequency.value === '') {
            showError(frequency, 'Please select cleaning frequency');
            isValid = false;
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.service-card-modern, .job-card, .area-card, .about-grid, .contact-grid, .stats, .feature-card, .testimonial-card, .faq-item').forEach(el => {
        el.style.opacity = 0;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!document.querySelector('script[type="application/ld+json"][data-schema="breadcrumb"]')) {
        ...
        breadcrumbScript.textContent = JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            "itemListElement": [
                {"@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.nestcarecleaningservices.co.uk/"},
                {"@type": "ListItem", "position": 2, "name": "Services", "item": "https://www.nestcarecleaningservices.co.uk/#services"},
                {"@type": "ListItem", "position": 3, "name": "Contact", "item": "https://www.nestcarecleaningservices.co.uk/#contact"}
            ]
        });
